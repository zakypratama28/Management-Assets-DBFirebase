...
>
  <head>
    ...
    <meta name="description" content="Login Aplikasi AssetPro" />
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Selamat Datang di AssetPro! 👋</h4>
              <p class="mb-4">Silakan login ke akun Anda untuk mulai mengelola aset.</p>
