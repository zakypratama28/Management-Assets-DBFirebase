...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($email) && !empty($password) && !empty($password_confirm)) {
        if ($password !== $password_confirm) {
            ...
            try {
                // Register user menggunakan Admin SDK
                $userProps = [
                    'email' => $email,
                    'password' => $password,
                ];
                
                // For local WAMP/Herd environments with missing cacert.pem
                $defaultCtx = stream_context_get_options(stream_context_get_default());
                ...
                stream_context_set_default($defaultCtx);
...
>
  <head>
    ...
    <title>Register — AssetPro</title>
    <meta name="description" content="Register Aplikasi AssetPro" />
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Buat akun agar dapat mengelola aset perusahaan Anda.</p>
              ...
              <?php if (!empty($success)): ?>
                <div class="alert alert-success" role="alert">
                  <?= htmlspecialchars($success) ?> <a href="login.php" class="fw-bold">Login disini</a>.
                </div>
              <?php endif; ?>
